...
import { addNumberToObj, displayValue, formatDate, getYear, getYearMonth } from '../lib/utils';
...
const aggregateDateWiseSummary = (rows, filters: any = {}) => {
  ...
  rows.forEach((row) => {
    ...
    addNumberToObj(agg, 'jumlahConesCheese', row.jumlahConesCheese);
    addNumberToObj(agg, 'produksiKgs', row.produksiKgs);
    addNumberToObj(agg, 'produksiLbs', row.produksiLbs);
    ...
    addNumberToObj(agg, 'powerElectricMin', row.powerElectricMin);
    addNumberToObj(agg, 'countMengubahMin', row.countMengubahMin);
    addNumberToObj(agg, 'creelMengubahMin', row.creelMengubahMin);
    addNumberToObj(agg, 'preventiveMtcMin', row.preventiveMtcMin);
    addNumberToObj(agg, 'creelShortStoppageMin', row.creelShortStoppageMin);
    addNumberToObj(agg, 'totalPenghentianMin', row.totalPenghentianMin);
    addNumberToObj(agg, 'powerPenghentian', row.powerPenghentian);
    addNumberToObj(agg, 'countMengubahLoss', row.countMengubahLoss);
    addNumberToObj(agg, 'creelMengubahLoss', row.creelMengubahLoss);
    addNumberToObj(agg, 'preventiveMtcLoss', row.preventiveMtcLoss);
    addNumberToObj(agg, 'creelShortLoss', row.creelShortLoss);
    addNumberToObj(agg, 'kerugianTotal', row.kerugianTotal);
    addNumberToObj(agg, 'produksiEffisiensiPercentSum', row.produksiEffisiensiPercent);
    addNumberToObj(agg, 'effisiensiKerjaPercentSum', row.effisiensiKerjaPercent);
    agg.count += 1;
  });
