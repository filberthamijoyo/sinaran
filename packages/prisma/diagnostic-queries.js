...
async function main() {
  ...
  `;
    ...
    const wrNoMatch = await prisma.$queryRaw `
    SELECT COUNT(*) FROM "WarpingRun" wr
  ...
  `;
    ...
    const irNoMatch = await prisma.$queryRaw `
  ...
  `;
    ...
    const wvNoMatch = await prisma.$queryRaw `
  ...
  `;
    ...
    const sampleKPs = await prisma.$queryRaw `
